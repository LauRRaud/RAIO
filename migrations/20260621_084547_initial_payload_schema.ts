...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('et', 'en');
  CREATE TYPE "public"."enum_pages_slug" AS ENUM('treeningud', 'vahendid', 'sundmused', 'pood', 'meist', 'journal', 'ostukorv', 'kontakt');
  CREATE TYPE "public"."enum_products_category" AS ENUM('sangpommid', 'hantlid', 'puidust-vahendid', 'lastele');
  CREATE TYPE "public"."enum_products_status" AS ENUM('AVAILABLE', 'MADE_TO_ORDER', 'PREORDER', 'TEMPORARILY_UNAVAILABLE');
  CREATE TYPE "public"."enum_journal_articles_category" AS ENUM('treening', 'loodus', 'kasitoo', 'motted');
  ...
  CREATE TABLE "products" (
  	...
  	"status" "enum_products_status" DEFAULT 'PREORDER' NOT NULL,
  ...
  CREATE TABLE "products_locales" (
  	...
  	"description" varchar,
  	"estimated_production_time" varchar,
  ...
  CREATE TABLE "journal_articles" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"slug" varchar NOT NULL,
  	"category" "enum_journal_articles_category",
  ...
  CREATE TABLE "site_settings_locales" (
  	"brand_name" varchar DEFAULT 'RA•IO',
  ...
  ALTER TABLE "journal_articles" ADD CONSTRAINT "journal_articles_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "home_page_cards" ADD CONSTRAINT "home_page_cards_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "home_page" ADD CONSTRAINT "home_page_philosophy_image_id_media_id_fk" FOREIGN KEY ("philosophy_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "journal_articles_image_idx" ON "journal_articles" USING btree ("image_id");
  ...
  CREATE INDEX "home_page_cards_order_idx" ON "home_page_cards" USING btree ("_order");
  CREATE INDEX "home_page_cards_parent_id_idx" ON "home_page_cards" USING btree ("_parent_id");
  CREATE INDEX "home_page_cards_locale_idx" ON "home_page_cards" USING btree ("_locale");
  CREATE INDEX "home_page_cards_image_idx" ON "home_page_cards" USING btree ("image_id");
  CREATE INDEX "home_page_hero_image_idx" ON "home_page" USING btree ("hero_image_id");
  CREATE INDEX "home_page_philosophy_image_idx" ON "home_page" USING btree ("philosophy_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_journal_articles_category";`)
}

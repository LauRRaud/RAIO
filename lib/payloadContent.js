...
function applyPageEditor(messages, editor) {
  ...
  applySection(messages, "trainingLasting", messages.training.lasting, editor.trainingLasting, { title: "title", text: "text", cta: "cta", image: "image", video: "video" });
  ...
  applySection(messages, "toolsMaterial", messages.tools.material, editor.toolsMaterial, { title: "title", text: "text", image: "image", video: "video" });
  ...
  applySection(messages, "eventsHost", messages.events.host, editor.eventsHost, { title: "title", text: "text", cta: "cta", image: "image", video: "video" });
  ...
  applySection(messages, "aboutStory", messages.about, editor.aboutStory, { title: "storyTitle", textLines: "story", image: "storyImage", video: "storyVideo" });
...
function trainingToViewModel(training, fallback) {
  ...
  return {
    ...
    /* Tühi = modaalis videoplokki ei ole; vaikeväärtust siin ei ole, sest
       messages/*.json ei sisalda videolinke. */
    video: training.videoUrl || "",
